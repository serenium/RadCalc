...
export const ISOTOPES: Isotope[] = [
  ...
  { name: 'Germanium-68 (Check Source)', symbol: 'Ge-68', halfLife: 271, halfLifeUnit: 'days', atomicNumber: 32, doseConstant: 0.018 }, // Approximate, similar to Ga-68
  ...
  { name: 'Rubidium-81', symbol: 'Rb-81', halfLife: 4.58, halfLifeUnit: 'hours', atomicNumber: 37, doseConstant: 0.13 }, // Estimated, similar to Rb-82
